...
class SeedsTwoScreen extends StatelessWidget {
  const SeedsTwoScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(children: [
                  Padding(
                      padding: EdgeInsets.only(left: 37.h, right: 28.h),
                      child: Row(
                  ...
                  Divider(),
                  Padding(
                      padding: EdgeInsets.fromLTRB(65.h, 8.v, 73.h, 8.v),
                      child: Row(
