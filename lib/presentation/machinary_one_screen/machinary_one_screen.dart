...
class MachinaryOneScreen extends StatelessWidget {
  const MachinaryOneScreen({Key? key}) : super(key: key);
            ...
            body: Container(
                ...
                child: Column(children: [
                  Align(
                      ...
                      child: Padding(
                          padding: EdgeInsets.only(left: 35.h, right: 55.h),
                          child: Row(children: [
                            CustomImageView(
                                imagePath: ImageConstant.imgRectangle86186x125,
                                height: 186.v,
                                width: 125.h,
                                radius: BorderRadius.circular(30.h)),
                            CustomImageView(
                                imagePath: ImageConstant.imgRectangle87186x125,
                                height: 186.v,
                                width: 125.h,
                                radius: BorderRadius.circular(30.h),
                  ...
                  Divider(),
                  Padding(
                      padding: EdgeInsets.fromLTRB(65.h, 9.v, 73.h, 13.v),
                      child: Row(
