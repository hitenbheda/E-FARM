...
class LandTwoScreen extends StatelessWidget {
  const LandTwoScreen({Key? key}) : super(key: key);
                ...
                child: Column(children: [
                  Padding(
                      ...
                      child: Row(
                          ...
                          children: [
                            CustomImageView(
                                imagePath: ImageConstant.imgRectangle902,
                                height: 168.v,
                                width: 150.h,
                                radius: BorderRadius.circular(30.h)),
                            CustomImageView(
                                imagePath: ImageConstant.imgRectangle912,
                                height: 168.v,
                                width: 128.h,
                                radius: BorderRadius.circular(30.h),
                  ...
                  Container(
                      margin:
                          EdgeInsets.only(left: 27.h, top: 34.v, right: 33.h),
                      padding:
                  ...
                  Divider(),
                  Padding(
                      padding: EdgeInsets.fromLTRB(65.h, 9.v, 73.h, 16.v),
                      child: Row(
